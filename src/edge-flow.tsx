...
import { TransitionMotion, spring, TransitionStyle, TransitionPlainStyle } from "react-motion";
...
export class EdgeFlow extends React.Component<IProps, IState> {
    ...
    public render() {
        ...
        let scale = new Scale(min, max, size, { width: 25, height: 10 }, { width: 25, height: 40 }, maxScale || 3);
        scale = new Scale(
            min,
            max,
            size,
        ...
        return (
            <div key="root" style={composedStyle}>
                ...
                >
                    ...
                    <TransitionMotion
                        key="svg-anim"
                        defaultStyles={defaultStyles as TransitionPlainStyle[]}
                        styles={motionSpringStyles as TransitionStyle[]}
                    >
                        {(styles: MotionStyle[]) => (
                            <g
                                key="g"
