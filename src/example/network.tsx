...
export default class Partition extends React.PureComponent<IProps, IState> {
    ...
    render() {
        ...
        const nodeStyle = { symbol: "\uf109", symbolColor: "white", symbolSize: 18, width: 10, height: 10 };
        const topicNode = { symbol: "\u2225", symbolColor: "white", symbolSize: 14, width: 10, height: 10 };
        ...
        return <div key="root"
            ...
            <EdgeFlowDag style={{ height: (height || 200), width: (width || 200), backgroundColor: "#080810" }} run={animate} >
                {[
                    <NodeDag key="source" id="source" {...nodeStyle} label="source" >
