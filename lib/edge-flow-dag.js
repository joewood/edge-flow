...
var EdgeFlowDag = (function (_super) {
    ...
    EdgeFlowDag.prototype.render = function () {
        ...
        return (React.createElement(edge_flow_1.EdgeFlow, __assign({}, props), nodes
            .map(function (node) { return (React.createElement(edge_flow_1.Node, __assign({ key: node.id, center: posNodes[node.id] }, node), groupedEdges[node.id] && groupedEdges[node.id]
