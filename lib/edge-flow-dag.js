...
var EdgeFlowDag = (function (_super) {
    ...
    EdgeFlowDag.prototype.render = function () {
        ...
        return (React.createElement(edge_flow_1.EdgeFlow, __assign({}, props), nodes
            ...
            return React.createElement(edge_flow_1.Edge, __assign({ key: edge.fromForceNode + "-" + edge.linkTo }, edge, { p0: round(ee.p0), p1: round(ee.p1), p2: round(ee.p2), p3: round(ee.p3) }));
        }))); })));
    };
    return EdgeFlowDag;
}(React.PureComponent));
