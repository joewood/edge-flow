...
var App = (function (_super) {
    ...
    function App(p) {
        ...
        _this.state = {
            animationIndex: 0, points: lodash_1.range(0, 24).map(function (pt, i, arr) { return circlePoint(i, arr.length); }),
        };
        return _this;
    }
    ...
    App.prototype.render = function () {
        ...
        return React.createElement("div", { id: "root", style: { display: "flex", flexDirection: "column", alignItems: "stretch", backgroundColor: "black" } },
            React.createElement(__1.EdgeFlow, { backgroundColor: "#0f0f0f", height: 600, width: 600, run: true }, points.map(function (p, i) {
