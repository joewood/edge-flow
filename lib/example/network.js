...
var Partition = /** @class */ (function (_super) {
    ...
    Partition.prototype.render = function () {
        ...
        return (React.createElement("div", { key: "root", style: {
            ...
            React.createElement(__1.EdgeFlowDag, { key: "edgeflow", style: { height: height || 200, width: width || 200, backgroundColor: "transparent" }, animate: animate, selectedNodeId: this.state.selectedNode, pathStyle: { width: 3, opacity: 0.1, color: "white" }, iconStyle: {
                    color: "#efefef",
                    fontSize: 28
                }, labelStyle: {
                    color: "#d0d0c0",
                ...
                this.state.nodes.map(function (n, i) {
                    return React.createElement(__1.NodeDag, __assign({ key: n && "node" + i, id: "node" + i }, topicNode, { label: "topic " + (i + 8) }),
