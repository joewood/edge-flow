...
var Partition = (function (_super) {
    ...
    Partition.prototype.render = function () {
        ...
        var inc = 1, x = 10, y = 10;
        var nodeStyle = { symbol: "\uf109", symbolColor: "white", symbolSize: 35, width: 10, height: 10 };
        var topicNode = { symbol: "\u2225", symbolColor: "white", symbolSize: 50, width: 2, height: 10 };
        var edgeStyle = { nonrandom: true, ratePerSecond: (this.state.flow), variationMax: 0.05, variationMin: -0.05, size: 10, shape: 0.65, color: "#ffff90", endingColor: "rgb(128,128,255)" };
        return React.createElement("div", { key: "root", style: { display: "flex", flexDirection: "column", alignItems: "stretch", backgroundColor: "black", height: height || 200, width: width || 200, overflow: "hidden" } },
            ...
            React.createElement(__1.EdgeFlowDag, { style: { height: (height || 200), width: (width || 200), backgroundColor: "#080810" }, run: animate }, [
                React.createElement(__1.NodeDag, __assign({ key: "source", id: "source" }, nodeStyle),
                ...
                React.createElement(__1.NodeDag, __assign({ key: "connector13", id: "connector13" }, topicNode), this.state.nodes
                    ...
                    .map(function (n, i) { return React.createElement(__1.EdgeDag, __assign({ linkTo: "node" + i, key: "node" + i }, edgeStyle)); }).concat([
                    React.createElement(__1.EdgeDag, __assign({ key: "21E", linkTo: "connector23" }, edgeStyle))
                ])),
                React.createElement(__1.NodeDag, __assign({ key: "connector23", id: "connector23" }, topicNode),
                    React.createElement(__1.EdgeDag, __assign({ key: "21E", linkTo: "target" }, edgeStyle))),
                React.createElement(__1.NodeDag, __assign({ key: "target", id: "target" }, nodeStyle))
            ].concat(this.state.nodes.map(function (n, i) { return React.createElement(__1.NodeDag, __assign({ key: "node" + i, id: "node" + i }, topicNode),
