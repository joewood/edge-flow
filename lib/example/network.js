...
var Partition = (function (_super) {
    ...
    Partition.prototype.render = function () {
        ...
        var nodeStyle = { symbol: "\uf109", symbolColor: "#efefef", labelColor: "#d0d0c0", symbolSize: 18, width: 20, height: 20, };
        var topicNode = { symbol: "\u2225", symbolColor: "#d8d8d8", labelColor: "#d0d0c0", symbolSize: 14, width: 10, height: 20 };
        ...
        return React.createElement("div", { key: "root", style: { display: "flex", flexDirection: "column", alignItems: "stretch", backgroundColor: "black", height: height || 200, width: width || 200, overflow: "hidden" } },
            ...
            React.createElement(__1.EdgeFlowDag, { style: { height: (height || 200), width: (width || 200), backgroundColor: "#080810" }, run: animate, selectedNodeId: this.state.selectedNode, onClickNode: this.selectNode }, [
