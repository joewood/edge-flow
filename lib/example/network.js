...
var Partition = (function (_super) {
    ...
    Partition.prototype.render = function () {
        ...
        return React.createElement("div", { key: "root", style: { display: "flex", flexDirection: "column", alignItems: "stretch", backgroundColor: "black", height: height || 200, width: width || 200, overflow: "hidden" } },
            ...
            React.createElement(__1.EdgeFlowDag, { style: { height: (height || 200), width: (width || 200), backgroundColor: "#020210" }, run: animate }, [
            ...
            ].concat(this.state.nodes.map(function (n, i) { return React.createElement(__1.NodeDag, { key: "node" + i, id: "node" + i, symbol: "\uf109", symbolColor: "white", symbolSize: 50 },
                React.createElement(__1.EdgeDag, { linkTo: "target", ratePerSecond: 8, size: 10, variationMax: 0.02, variationMin: -0.02, shape: 1, color: "green", endingColor: "red" })); }))));
    };
    return Partition;
}(React.PureComponent));
