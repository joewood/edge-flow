...
var Partition = (function (_super) {
    ...
    Partition.prototype.render = function () {
        ...
        var inc = 1, x = 10, y = 10;
        return React.createElement("div", { key: "root", style: { display: "flex", flexDirection: "column", alignItems: "stretch", backgroundColor: "#303080", height: height || 200, width: width || 200, overflow: "hidden" } },
            React.createElement(__1.EdgeFlowDag, { style: { height: (height || 200) * 0.9, width: (width || 200) * 0.9, backgroundColor: "#303080" }, run: animate },
