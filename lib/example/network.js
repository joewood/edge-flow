...
var Network = /** @class */ (function (_super) {
    ...
    function Network(p) {
        ...
        _this.selectNode = function (args) {
            _this.props.onSelectNode(args.nodeId);
        };
        _this.state = {
            flow: 10
        };
    ...
    Network.prototype.componentWillUnmounnt = function () {
        if (this.interval1)
    ...
    Network.prototype.render = function () {
        ...
        return (React.createElement("div", { key: "root", style: {
                display: "flex",
            ...
            React.createElement(__1.EdgeFlowDag, { key: "edgeflow", style: { height: height || 200, width: width || 200, backgroundColor: "transparent" }, animate: animate, selectedNodeId: this.props.selectedNode, pathStyle: { width: 3, opacity: 0.1, color: "white" }, iconStyle: {
                    color: "#efefef",
                    fontSize: 28
                }, labelStyle: {
                    color: "#d0d0c0",
                ...
                React.createElement(__1.NodeDag, __assign({ key: "connector12", id: "connector12" }, topicNode, { label: "topic 5" }),
                    React.createElement(__1.EdgeDag, __assign({ key: "21E", linkTo: "target" }, edgeStyle))),
                React.createElement(__1.NodeDag, __assign({ key: "connector13", id: "connector13" }, topicNode, { label: "Unknown" }),
                    this.props.nodes
                        .filter(function (n, i) { return (n && i) % 2 == 1; })
                        .map(function (n, i) { return React.createElement(__1.EdgeDag, __assign({ linkTo: n && "node" + i, key: "node" + i }, edgeStyle)); }),
                    React.createElement(__1.EdgeDag, __assign({ key: "21E", linkTo: "connector23" }, edgeStyle))),
                React.createElement(__1.NodeDag, __assign({ key: "connector23", id: "connector23" }, topicNode, { label: "topic" }),
                    React.createElement(__1.EdgeDag, __assign({ key: "21E", linkTo: "target" }, edgeStyle))),
                this.props.nodes.map(function (n) { return (React.createElement(__1.NodeDag, __assign({ key: n && n.name, id: n.name }, topicNode, { label: n.name }),
                    React.createElement(__1.EdgeDag, __assign({ linkTo: n.name.charCodeAt(n.name.length - 1) % 2 ? "target" : "connector23" }, edgeStyle)))); }),
