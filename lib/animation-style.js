...
function createEdgeStyle(edge, nodeDict, scale /* min: IPoint, max: IPoint, size: IPoint*/) {
...
function createDefaultNodeStyle(node, point, scale /* min: IPoint, max: IPoint, size: IPoint*/) {
    return {
        key: node.id,
        style: {
