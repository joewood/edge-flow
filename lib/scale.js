...
var Scale = (function () {
    ...
    Scale.prototype.updateScale = function () {
        ...
        var scaleuniform = Math.min(Math.min(this.screenSize.width / this.virtualSize.width, this.screenSize.height / this.virtualSize.height), this.maxScale);
        ...
        if (this.toScreenScale.x > (2 * this.toScreenScale.y))
            this.toScreenScale.x = this.toScreenScale.y * 2;
        if (this.toScreenScale.y > (2 * this.toScreenScale.x))
            this.toScreenScale.y = this.toScreenScale.x * 2;
    };
