...
var Scale = (function () {
    ...
    Scale.prototype.updateScale = function () {
        ...
        if (this.toScreenScale.x > (3 * this.toScreenScale.y))
            this.toScreenScale.x = this.toScreenScale.y * 3;
        if (this.toScreenScale.y > (3 * this.toScreenScale.x))
            this.toScreenScale.y = this.toScreenScale.x * 3;
    };
