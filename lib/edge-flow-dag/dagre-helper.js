...
function getGraphFromNodes(childrenNodes) {
    ...
    var nodes = mapChild(childrenNodes, function (props) { return (__assign({}, props, { label: props.label, width: 20, height: 15, links: mapChild(props.children, function (cc) { return cc; }) })); });
...
function getLayout(g, childrenNodes, width, height) {
    g.rankdir = "LR";
    var forceLayout = layout.layout(g, { rankdir: "LR" });
    var nodes = g.nodes();
