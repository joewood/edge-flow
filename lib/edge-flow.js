    ...
    EdgeFlow.prototype.render = function () {
        ...
        return (React.createElement("div", { key: "root", style: composedStyle },
            ...
            React.createElement(react_motion_1.TransitionMotion, { key: "motion-anim", defaultStyles: defaultStyles, styles: springStyles }, function (styles) {
                return React.createElement(partican_1.ParticleCanvas, { key: "particles", style: { width: diagramWidth, height: diagramHeight, backgroundColor: backgroundColor }, defaultParticleStyle: particleStyle, run: animate }, animation_style_1.isEdgeStyles(styles).map(function (edgeStyle) {
                    return React.createElement(partican_1.ParticleEdge, __assign({ key: edgeStyle.data.from.id + "-" + edgeStyle.data.linkTo }, edgeStyle.data, { particleStyle: __assign({}, defaults.particleStyle, particleStyle, edgeStyle.data.particleStyle, { size: scale.avgSizeToScreen(edgeStyle.data.particleStyle && edgeStyle.data.particleStyle.size || 10) }), p0: {
