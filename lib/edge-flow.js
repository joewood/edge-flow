...
var EdgeFlow = (function (_super) {
    ...
    EdgeFlow.prototype.render = function () {
        ...
        var scale = new scale_1.Scale(min, max, size, { width: 10, height: 30 });
            ...
            React.createElement("svg", { key: "svg", width: width, height: height, style: { left: 0, top: 0, backgroundColor: backgroundColor, position: "absolute" }, onClick: function () { return onClickNode && onClickNode({ nodeId: null, graph: null, screen: null }); } },
                ...
                React.createElement(react_motion_1.TransitionMotion, { key: "svg-anim", defaultStyles: defaultStyles, styles: springStyles }, function (styles) {
                    return React.createElement("g", { key: "g" }, svgLineFn(animation_style_1.isEdgeStyles(styles), scale).concat(animation_style_1.isNodeStyles(styles)
                        ...
                        return React.createElement(svg_components_1.WrappedSvgText, { key: "TEXT-" + nodeStyle.key, x: nodeStyle.style.x, y: nodeStyle.style.y + scale.heightToScreen(nodeStyle.data.height || 10), height: scale.heightToScreen(scale.heightToScreen(40 + 10)), width: scale.widthToScreen(scale.widthToScreen(2 * (nodeStyle.data.width || 10))), fontWeight: nodeStyle.data.group ? 800 : 400, text: "" + nodeStyle.data.label, top: true, center: true, glow: selectedNodeId === nodeStyle.key, lineHeight: scale.avgSizeToScreen(6), fontWidth: scale.avgSizeToScreen(6), textColor: nodeStyle.data.labelColor || "#f0f0f0" });
                        ...
                        return nodeStyle.data.symbol
                            ? React.createElement("text", { key: "SYM-" + nodeStyle.key, x: nodeStyle.style.x, y: nodeStyle.style.y, height: scale.heightToScreen(24), width: scale.widthToScreen(80), onClick: function (c) {
                                    ...
                                    c.stopPropagation();
                                }, filter: selectedNodeId === nodeStyle.key ? "url(#glow)" : undefined, style: {
                                    userSelect: "none",
                                    cursor: "default",
                            ...
                            : React.createElement("circle", { key: "SYM-" + nodeStyle.key, cx: nodeStyle.style.x, cy: nodeStyle.style.y, onClick: function (c) {
                                    ...
                                    c.stopPropagation();
                                }, r: scale.smallestSizeToScreen(((selectedNodeId === nodeStyle.key) ? 9 : 5)), fill: nodeStyle.data.symbolColor || "#80ff80", strokeWidth: (selectedNodeId === nodeStyle.key) ? 3 : 0, stroke: (selectedNodeId === nodeStyle.key) ? "white" : "transparent" });
                    })));
                }),
                ")"),
