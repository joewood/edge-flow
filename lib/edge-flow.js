...
var EdgeFlow = (function (_super) {
    ...
    EdgeFlow.prototype.render = function () {
        ...
        var scale = new scale_1.Scale(min, max, size, { width: 25, height: 10 }, { width: 25, height: 40 });
        scale = new scale_1.Scale(min, max, size, { width: 25, height: 10 }, { width: 25, height: scale.screenHeightToVirtual(scale.avgSizeToScreen(30)) });
        ...
        var svgLineFn = function (styles, scale) {
            return styles
                ...
                return React.createElement("path", { key: edgeStyle.key, d: "M" + style.p0x + "," + style.p0y + " C " + style.p1x + "," + style.p1y + " " + style.p2x + "," + style.p2y + " " + style.p3x + "," + style.p3y, stroke: edge.pathColor || defaulltStrokeColor, opacity: edge.pathOpacity || 0.05, fill: "transparent", strokeWidth: scale.avgSizeToScreen(edge.pathWidth || 4) });
            });
        };
            ...
            React.createElement("svg", { key: "svg", width: width, height: height, style: { left: 0, top: 0, backgroundColor: backgroundColor, position: "absolute" }, onClick: function () { return onClickNode && onClickNode({ nodeId: null, graph: null, screen: null }); } },
                ...
                React.createElement(react_motion_1.TransitionMotion, { key: "svg-anim", defaultStyles: defaultStyles, styles: springStyles }, function (styles) {
                    return React.createElement("g", { key: "g" }, svgLineFn(animation_style_1.isEdgeStyles(styles), scale).concat(animation_style_1.isNodeStyles(styles)
                        ...
                        return React.createElement(svg_components_1.WrappedSvgText, { key: "TEXT-" + nodeStyle.key, x: nodeStyle.style.x, y: nodeStyle.style.y + scale.avgSizeToScreen(10), height: scale.heightToScreen(40), width: scale.widthToScreen(40), fontWeight: nodeStyle.data.group ? 800 : 400, text: "" + nodeStyle.data.label, top: true, center: true, glow: false /*selectedNodeId === nodeStyle.key*/, lineHeight: scale.avgSizeToScreen(6), fontWidth: scale.avgSizeToScreen(6), textColor: nodeStyle.data.labelColor || "#f0f0f0" });
                        ...
                        return nodeStyle.data.symbol
                            ? React.createElement("text", { key: "SYM-" + nodeStyle.key, x: nodeStyle.style.x, y: nodeStyle.style.y, height: scale.avgSizeToScreen(20), width: scale.avgSizeToScreen(20), onClick: function (c) {
                                    console.log("Click");
                                    onClickNode && onClickNode({ nodeId: nodeStyle.key, graph: { x: nodeStyle.style.x, y: nodeStyle.style.y }, screen: null });
                                    c.stopPropagation();
                                }, filter: selectedNodeId === nodeStyle.key ? "url(#symglow)" : undefined, style: {
                                    userSelect: "none",
                                    cursor: "default",
                            ...
                            : React.createElement("circle", { key: "SYM-" + nodeStyle.key, cx: nodeStyle.style.x, cy: nodeStyle.style.y, onClick: function (c) {
                                    ...
                                    c.stopPropagation();
                                }, r: scale.avgSizeToScreen(((selectedNodeId === nodeStyle.key) ? 9 : 5)), fill: nodeStyle.data.symbolColor || "#80ff80", strokeWidth: (selectedNodeId === nodeStyle.key) ? 0 : 1, stroke: (selectedNodeId === nodeStyle.key) ? "white" : "transparent" });
                    })));
                }),
                ")"),
            React.createElement("div", { key: "particleContainer", style: { pointerEvents: "none", position: "absolute", left: 0, top: 0 } },
                React.createElement(react_motion_1.TransitionMotion, { key: "motion-anim", defaultStyles: defaultStyles, styles: springStyles }, function (styles) {
                    return React.createElement(particle_canvas_1.ParticleCanvas, { key: "particles", width: diagramWidth, height: diagramHeight, run: run, backgroundColor: backgroundColor }, animation_style_1.isEdgeStyles(styles)
                        .map(function (edgeStyle) {
                        return React.createElement(particle_canvas_1.ParticleEdge, __assign({ key: edgeStyle.data.from.id + "-" + edgeStyle.data.linkTo }, edgeStyle.data, { size: scale.avgSizeToScreen(edgeStyle.data.size || 10), p0: {
